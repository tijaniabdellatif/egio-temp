...
(function (root, factory) {
    ...
    var document = window.document,
        ...
        renderMonthsOfYear = function (el, opts, date) {
            ...
            html +=
                '<h1 class="lightpick__month-title">' +
                ym.format("YYYY") +
                "</h1>";
        ...
        Lightpick = function (options) {
            ...
            self._onMouseDown = function (e) {
                ...
                if (
                    ...
                    target.classList.contains("lightpick__month-title")
                ) {
                    if (target.hasAttribute("data-ym")) {
                        ...
                        renderMonthsOfYear(
                            self.el,
                            opts,
                            target.getAttribute("data-ym")
                        );
                    }
                } else if (target.hasAttribute("data-goto-month")) {
                    var month = moment(
                        target.getAttribute("data-goto-month"),
                        "YYYY-M"
                    );
                    if (month.isValid()) {
                        self.gotoDate(month);
                ...
                if ((opts.startDate && !opts.endDate) || opts.repick) {
                    ...
                    if (opts.hoveringTooltip) {
                        ...
                        for (const disableDay of disabledDates) {
                            if (
                                startDate.unix() < disableDay &&
                                disableDay < hoverDate.unix()
                            ) {
                                days -= 1;
                            }
                        }
            ...
            self._onChange = function (e) {
                ...
                if (target.classList.contains("is-selected-lightpick-month")) {
                    ...
                    target.classList.contains("is-selected-lightpick-year")
                ) {
