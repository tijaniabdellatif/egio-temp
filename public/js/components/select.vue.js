const MultiSelect = {
    /*html*/
    template: `
        <div class="dropdown bootstrap-select fit-width show dropup">
            <select class="selectpicker" @change="change($event)">
                <option v-for="o of options" :value="o.val">@{{o.label}}</option>
            </select>
            ...
            <div class="dropdown-menu show" style="max-height: 661.992px; overflow: hidden; min-height: 46px; position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, -162px, 0px);">
                <div class="bs-searchbox">
                    <input type="search" class="form-control">
                </div>
                <div class="inner show">
                    <ul class="dropdown-menu inner show" style="margin-top: 0px; margin-bottom: 0px;">
                        <li v-for="o of options" :class="o.val==selected?'selected active':''">
                            <a class="dropdown-item" :class="o.val==selected?'selected active':''" @click="change1(o)">
