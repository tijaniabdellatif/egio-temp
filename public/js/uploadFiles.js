const uploadImages = function (files, callback, progress) {
    ...
    // using axios to upload images, post to /api/v1/uploadImages
    // grt the progress of the upload and call the callback function

    axios.post('/api/v1/uploadImages', form, {
        headers: {
...
const uploadVideos = function (files, callback, progress) {


    // using axios to upload videos, post to /api/v1/uploadVideos
    // grt the progress of the upload and call the callback function
    ...
    axios.post('/api/v1/uploadVideos', form, {
        headers: {
            'Content-Type': 'multipart/form-data'
        },
        onUploadProgress: function (progressEvent) {
...
const uploadAudios = function (files, callback, progress) {


    // using axios to upload audios, post to /api/v1/uploadAudios
    // grt the progress of the upload and call the callback function

    var form = new FormData();
    for (var i = 0; i < files.length; i++) {
        form.append("audios[]", files[i]);
    }

    axios.post('/api/v1/uploadAudios', form, {
        headers: {
            'Content-Type': 'multipart/form-data'
        },
        onUploadProgress: function (progressEvent) {
