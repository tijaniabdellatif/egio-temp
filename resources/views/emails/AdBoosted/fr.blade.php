            ...
            >
              ...
              <tr>
                <td style="padding: 30px; background-color: #ffffff">
                    ...
                    "
                  >
                  {{ $designation }} Activée(s) avec succès !
                  </h1>
                  <h2
                    style="
                      margin-top: 0;
                  ...
                  ">
                  Vos options de visibilité ont été activées avec succès !
                  Votre solde actuel de Listcoins est de :<br/>
                  <p style="font-size : 24px">{{ $coins }} LTC</p>
                  </p>
                </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <![endif]-->
                  ...
                  >
                    ...
                    ">
                        Alimentez votre solde à tout moment depuis votre espace personnel.
                    </p>
                    <p
                      style="
                        margin-top: 0;
