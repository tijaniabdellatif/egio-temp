        ...
        <tr>
          ...
          <![endif]-->
            ...
            >
              <tr>
                ...
                >
                  <img
                    src="{{ secure_asset("images/Header.png") }}"
                    width="100%"
                    alt="Logo"
                    style="
                      width: 100%;
              ...
              <tr>
                <td style="padding: 30px; background-color: #ffffff">
                  ...
                  ">
                    Une personne est intéressée par votre annonce
                  </p>
                </td>
              </tr>
              <tr>
                ...
                >
                      ...
                      position: relative;">
                        ...
                        padding: 10px;">
                            ...
                            margin-bottom: 3px;">
                            <img
                            src="{{ secure_asset("images/location.png") }}"
                            width="50"
                            height="20"
                            alt="Booklist"
              ...
              <tr>
                ...
                <![endif]-->
                  ...
                  >
                    ...
                    ">
                       Prenez contact avec votre client potentiel sans plus attendre : </p>
                        <div style="border: solid 1px rgb(218, 218, 218)">
                        <b>Nom :</b> {{ $name }}<br/>
                        ...
                        <p>
                        Actualisez en permanence votre parc en accédant à votre espace personnel,
                    </p>
                    <p
                      style="
                        margin-top: 0;
            ...
            <!--- Footer --->
                ...
                <tr style="text-align: center;">
                  ...
                  >
                    <a
                      ...
                      ><img
                        src="{{ secure_asset("images/booklistmail.png") }}"
                        width="70"
                        height="40"
                        alt="Booklist"
                  ...
                  >
                    <a
                      ...
                      style="text-decoration: none"
                      ><img
                        src="{{ secure_asset("images/homelistmail.png") }}"
                        width="70"
                        height="40"
                        alt="Homelist"
                        style="display: inline-block; color: #cccccc; object-fit:contain"
                  ...
                  >
                    <a
                      ...
                      style="text-decoration: none"
                      ><img
                        src="{{ secure_asset("images/primelistmail.png") }}"
                        width="70"
                        height="40"
                        alt="primelist"
                        style="display: inline-block; color: #cccccc; object-fit:contain"
                  ...
                  >
                    <a
                      ...
                      style="text-decoration: none"
                      ><img
                        src="{{ secure_asset("images/landlistmail.png") }}"
                        width="70"
                        height="40"
                        alt="Landlist"
                        style="display: inline-block; color: #cccccc; object-fit:contain"
                  ...
                  >
                    <a
                      ...
                      style="text-decoration: none"
                      ><img
                        src="{{ secure_asset("images/officelistmail.png") }}"
                        width="70"
                        height="40"
                        alt="Officelist"
                        style="display: inline-block; color: #cccccc; object-fit:contain"
               ...
               <tr>
                ...
                >
                  <a
                    ...
                    style="text-decoration: none"
                    ><img
                      src="{{ secure_asset("images/facebbokgrey.png") }}"
                      width="60"
                      height="30"
                      alt="Facebook"
              ...
              >
                <a
                  ...
                  style="text-decoration: none"
                  ><img
                    src="{{ secure_asset("images/instagrey.png") }}"
                    width="60"
                    height="30"
                    alt="Instagram"
                    style="display: inline-block; color: #cccccc; object-fit:contain"
            ...
            >
              <a
                ...
                style="text-decoration: none"
                ><img
                  src="{{ secure_asset("images/youtubegrey.png") }}"
                  width="60"
                  height="30"
                  alt="Booklist"
                  style="display: inline-block; color: #cccccc; object-fit:contain"
          ...
          >
            <a
              ...
              style="text-decoration: none"
              ><img
                src="{{ secure_asset("images/linkedingrey.png") }}"
                width="60"
                height="30"
                alt="Booklist"
                style="display: inline-block; color: #cccccc; object-fit:contain"
