            ...
            >
              ...
              <tr>
                <td style="padding: 30px; background-color: #ffffff">
                  ...
                  ">
                 Bienvenue <span style="color:#4CC6D6;">{{ $email }}</span> Le bien que vous avez publié sur les sites d’annonces immobilières n’a toujours pas trouvé preneur ? Pas de soucis ! Augmentez vos chances en donnant votre accord pour sa publication sur le 1er moteur de recherche de l’immobilier au Maroc,
                 <strong>Multilist.immo.</strong>
                  </p>
                </td>
              </tr>
              <tr>
                ...
                ><img
                  src="{{ secure_asset("images/Laptop_new.png") }}"
                  width="540"
                  alt=""
                  style="
                    width: 100%;
              ...
              <tr>
                ...
                <![endif]-->
                  ...
                  >
                    ...
                    ">
                      Il vous suffit d’accepter sa publication en cliquant sur le bouton.
                    </p>




                    <p style="margin-top:0;margin-bottom:18px;font-weight: 600;">
                      L’équipe Multilist,

                    </p>
                    <p style="margin: 0; padding:30px;">
                      <a
                      href="https://multilist.immo/conditions?token={{ $token }}"
                        style="
                          background: #4CC6D6;
                          text-decoration: none;
                          padding: 10px 25px;
