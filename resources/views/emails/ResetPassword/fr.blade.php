            ...
            >
              ...
              <tr>
                <td style="padding: 8px; background-color: #ffffff">
                  ...
                  Entrez le code suivant pour réinitialiser votre mot de passe :<br/>
                  <span style="text-align: center; font-size:18px;"><b>{{ $code }}</b></span>
                  </p>
                </td>
              </tr>
              ...
              <tr>
                ...
                <![endif]-->
                  ...
                  >
                    ...
                    ">
                        Vous pouvez également le changer directement depuis le lien :
                      <a href='https://{{ $host_name }}/resetpassword?id={{ $id }}&code={{ $code }}'><span style="text-decoration: underline; color:#67bfd3">Reinitialiser votre mot de passe</span></a>  <br/>
                        Pour des raisons de sécurité, veuillez ne pas partager le lien communiqué.
                    </p>
                    <p
                      style="
                        margin-top: 0;
