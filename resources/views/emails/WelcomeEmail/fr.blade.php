          ...
          <![endif]-->
            <table
              ...
              style="
                ...
                color: #363636;
                border-bottom:none;
                border-left:4px groove #706f6f0f;
                border-top:4px groove #706f6f0f;
                border-right:4px groove #706f6f0f;
                border-radius : 10px;
            ...
            >
              ...
              <tr>
                <td style="padding: 30px; background-color: #ffffff">
                  ...
                  ">
                 La migration étant finalisée, nous avons le plaisir de vous informer que la
                 <strong>nouvelle plateforme</strong> de Multilist est <strong>officiellement opérationnelle !</strong>
                  </p>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <![endif]-->
                  ...
                  >
                    ...
                    ">
                      Pour des raisons de sécurité, un mot de passe générique vous a été
                      attribué. Vous avez la possibilité de le changer à tout moment en vous
                    ...
                    <p style="margin-top:0;margin-bottom:18px;font-weight: 600;"></p>
                    <p style="margin: 0; padding:30px;">
                      <a
                      href="https://multilist.immo/resetpassword?email={{ $email }}"
                        style="
                          background: #4CC6D6;
                          text-decoration: none;
                          padding: 10px 25px;
                ...
                <center style="width: 100%;">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
                              style="
                                ...
                                border-top:none;
                                border-left:4px groove #706f6f0f;
                                border-bottom:4px groove #706f6f0f;
                                border-right:4px groove #706f6f0f;
                                border-radius : 10px;
                                font-family: Montserrat, Arial;
                              ">
                      <tr>
                         <td>
                              ...
                              <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
                                  <tbody>
                                      <tr>
                                          <td style="position:relative;text-align:center;padding: 30px 30px 15px 30px;" class="policy">
                                              <h2 style="font-size: 18px; color: #4CC6D6; font-weight: 600; margin: 0;">Politique des mots de passe</h2>
                                          </td>
                                      </tr>

                                      <tr>
                                          <td style="text-align:center;padding: 20px 30px 40px">
                                              <p>Pour des raisons de sécurité, suivez les recommandations suivantes</p>
                                              <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">
                                               Le mot de passe doit contenir au minimum <strong>8 caractères</strong>
                                              </p>

                                              <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">
                                                Le mot de passe doit contenir  <strong>des alphabets des numéros et des caractères spéciaux</strong>

                                               </p>

                                               <p style="margin: 0; font-size: 13px; line-height: 22px; color:#9ea8bb;">

                                                Si vous rencontrez des problèmes contactez nous par mail sur <strong style="color:#4CC6D6">contact@multilist.ma</strong>
