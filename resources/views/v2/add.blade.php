...
@section('title', "Déposer/ajouter une annonce immobilière garatuite | Multilist")
...
@section('content')
    ...
    <div class="container-md" style="max-width: 850px;">
        ...
        <section id="add-section" class="add-section " @if(Session::get('lang') === 'ar') dir="rtl" @endif>
            ...
            <div class="section-title page-title">{{ __('general.Nouvelle annonce') }}</div>

            <div class="">

                <section class="item-section" id="type-section">
                    <div class="section-heading translate">
                        <h1 class="translate">{{ __('general.Type') }} :</h1>
                        <div class="heading-underline"></div>
                    </div>

                    <div class="type-cards-container">
                        <div v-for="t of types" class="type-card" :class="t.val == type ? 'active-card' : ''"
                    ...
                    <div class="">
                        <div class="row localisation-row">
                            <div class="form-group mb-4">
                                ...
                                <div>
                                    <select v-model="form.loccity" id="cities-select" class="form-select onlyMobile" @change="changeCity()">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="d-flex" id="quartier-select">
                                    <div id="master-loader" class="mx-1 spinner-border text-primary p-2 d-none" role="status">
                                ...
                                <div>
                                    <select v-model="form.locdept" id="neighborhoods-select" class="form-select onlyMobile" :disabled="form.loccity == null" @change="changeDept()">
                        ...
                        <div class="col-6 mb-4" id="dept2_cnt" v-if="form.locdept==-1" style="display:flex; flex-direction:column">
                            <label class="col-sm-4 col-form-label" style="margin-right:64px;">{{ __('general.Autre quartier') }}</label>
                            <div class="col-sm-8">
                                <input id="locdept2" name="dept2" type="text" class="form-control autre-loc" maxlength="199"
                                    v-model="form.locdept2">
                            </div>
                            <div class="invalid-feedback" style="display:block">
                                @{{ errors.locdept2?.join('<br/>') }}
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 translate">
                            ...
                            <div class="col-sm-8">
                                <input name="title" type="text" class="form-control"
                                    :class="errors.title ? 'is-invalid' : ''" v-model="form.title" data-toggle="tooltip" data-placement="top" title="Ne doit pas dépasser 60 caractères" value="44">
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3 translate">
                            ...
                            <div class="col-sm-8">
                                <input name="ref" type="text" class="form-control"
                                    :class="errors.ref ? 'is-invalid' : ''" v-model="form.ref" data-toggle="tooltip" data-placement="top" title="Votre référence commerciale ou interne" value="44">
                                <div class="invalid-feedback">
                                    @{{ errors.ref?.join('<br/>') }}
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 translate">
                            ...
                            <div class="col-sm-8">
                                <textarea name="desc" class="form-control" :class="errors.description ? 'is-invalid' : ''" style="height: 200px"
                                    v-model="form.description" placeholder="Maximum 5000 caractères ..." maxlength="5000"></textarea>
                ...
                <section v-if="form.catid&&!form.user_id" class="item-section translate" id="places-section">
                    ...
                    <div class="login-form">
                        ...
                        <div class="form-group" style="padding: 10px;">
                            <label for="firstname">{{ __('general.Prénom') }} <span style="color: red">*</span> :</label>
                        ...
                        {{-- form-group lastname --}}
                        <div class="form-group" style="padding: 10px;">
                            <label for="lastname">{{ __('general.votre nom') }} <span style="color: red">*</span> :</label>
                        ...
                        {{-- form-group username --}}
                        <div class="form-group" style="padding: 10px;">
                            <label for="username">{{ __('general.Nom d\'utilisateur') }} <span style="color: red">*</span> :</label>
                        ...
                        {{-- form-group email --}}
                        <div class="form-group" style="padding: 10px;">
                            <label for="email">{{ __('general.Email') }} <span style="color: red">*</span> :</label>
                        ...
                        {{-- form-group phone --}}
                        <div class="form-group" style="padding: 10px;">
                            <label for="phone">{{ __('general.Numéro de téléphone') }} <span style="color: red">*</span> :</label>
                            <input type="phone" class="form-control" :class="errors.phone ? 'is-invalid' : ''"
                                v-model="registerForm.phone" id="phone3" ref="phone3" placeholder="{{ __('general.Numéro de téléphone') }}">
                            <div class="invalid-feedback">
                                @{{ errors.phone?.join('<br/>') }}
                            </div>
                        </div>
                        {{-- form-group password --}}
                        <div class="form-group" style="padding: 10px;">
                            <label for="password">{{ __('general.Mot de passe') }} <span style="color: red">*</span> :</label>
                        ...
                        <div class="form-group" style="padding: 10px;">
                            <label for="password2">{{ __('general.Confirmez votre mot de passe') }} <span style="color: red">*</span> :</label>
                            ...
                            axios.get("/api/v2/city/getCityById?id=" + this.form.loccity)
                                .then((cityResponse) => {
                                    ...
                                    if(this.form.locdept){
                                        axios.get("/api/v2/neighborhood/getNeighborhoodById?id=" + this.form.locdept)
                                            .then((deptResponse) => {
                                                ...
                                                const config = {
                                                    ...
                                                    url: `https://multilistbot.online:5000/`,
                                                    headers: {
                                        ...
                                        this.descLoading = true;
                                        axios(config,{httpsAgent}).then(response => {
                                            this.form.description = response.data.description;
                                            this.descLoading = false;
                                        })
                                        .catch((error)=> {
                ...
                changeCity() {
                    ...
                    axios.post("{{ route('api.loadDeptsByCity') }}", {
                            ...
                            if (data.success) {
                                ...
                                // document.querySelector("#quartier-select").classList.remove("d-none")
                                setInterval(() => {
                                    document.querySelector("#master-loader").classList.add("d-none")
                                }, 2000);
                            }
                        })
                    ...
                    axios(config)
                        .then((response) => {
                            ...
                            if (response.data.success == true) {
                                swal("Votre annonce est en cours de modération!", "", "success").then(() => {
