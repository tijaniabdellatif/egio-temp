...
@section('title', 'Catalogue des pages')
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="show-edit">
                            <!-- TinyMCE Editor --><textarea id="tinymce-editor"></textarea><!-- End TinyMCE Editor -->
                            <div class="card">
                                <div class="card-body" style="text-align: center;padding-top:20px;">
                                    ...
                                    <button onclick="event.preventDefault();" @click="hideEdit()" class="btn btn-outline-success">Annuler</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns datatable" id="datatable">
                            <div class="dataTable-container table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col"><div class="datatable-column noselect">page template</div></th>
                                            <th scope="col"><div class="datatable-column noselect">Action</div></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr v-for="d of data" class="">
                                            <td>@{{d.name}} | @{{d.lang}}</td>
                                            <td>
                                                <button @click="showEdit(d)" class="btn p-0 m-0 me-2"><i class="fas fa-edit text-success"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
  ...
  content_style: 'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'
        ...
        Vue.createApp({
            ...
            mounted() {
                ...
                $.getJSON("/assets/statics/pages.json", (data)=>{
            ...
            methods: {
                showEdit(data){
                    this.loader = true;
                    axios.get('/api/v2/staticfiles?path=resources/views/pages/'+data.folder+'/'+data.lang+'.blade.php')
                        .then(response => {
                            this.loader = false;
                ...
                save(){
                    ...
                    var config = {
                        ...
                        data:{
                            path:'resources/views/pages/'+this.selected+'/'+this.lang+'.blade.php',
                            text: finalContent
                        }
                    };
                    axios(config)
